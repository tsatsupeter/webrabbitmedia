  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        slug: 'webhooks',
        title: 'Webhooks',
        summary: 'Signed, retried event delivery for collections, payouts and top-ups.',
        Component: Webhooks,
        headings: [
          { id: 'register', text: 'Register an endpoint', depth: 2 },
          { id: 'events', text: 'Events', depth: 2 },
          { id: 'payload', text: 'Payload', depth: 2 },
          { id: 'headers', text: 'Headers', depth: 2 },
          { id: 'verify', text: 'Verify the signature', depth: 2 },
          { id: 'retries', text: 'Retries and failures', depth: 2 },
          { id: 'polling', text: 'Polling fallback', depth: 2 },
        ],
      },
    ],
  },
